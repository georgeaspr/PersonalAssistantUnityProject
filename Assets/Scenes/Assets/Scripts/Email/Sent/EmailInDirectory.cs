...
public class EmailInDirectory : MonoBehaviour
{
    ...
    {
        GameObject sampleButton = buttonContainer.transform.Find("EmailButton").gameObject;
        ...
        Debug.Log("emailFolderPath: " + emailFolderPath);
        Debug.Log("sentFolderPath: " + sentFolderPath);
        
        string[] files = Directory.GetFiles(sentFolderPath);
        ...
        for (int i = 0; i < files.Length; i++)
        {
            ...
            try
            {
                ...
                if (lines.Length >= 1)
                {
                    Text firstLineText = button.transform.Find("To").GetComponent<Text>();
                    firstLineText.text = "To: " + TruncateText(lines[0], 15);
                }
                if (lines.Length >= 2)
                {
